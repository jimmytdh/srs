            ...
            @if(!isset($edit))
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <form method="post" action="{{ url('admin/designation/save') }}">
                                {{ csrf_field() }}
                                <div class="box-body">
            ...
            @else
                <div class="col-md-4">
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            <form method="post" action="{{ url('admin/designation/update/'.$info->id) }}">
                                {{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="code">Code</label>
                                ...
                                <div class="box-footer">
                                    <a href="{{ url('admin/designation') }}" class="pull-left btn btn-default">
            ...
            <div class="col-md-8">
                <div class="box box-success">
                    <div class="box-header">
                        ...
                        <br />
                        <?php $keyword = \Illuminate\Support\Facades\Session::get('search_designation'); ?>
                        @if($keyword)
                            <small class="text-danger">Keyword: {{ $keyword }}</small>
                        @endif

                        <div class="box-tools">
                            <form method="post" action="{{ url('admin/designation/search') }}">
                                {{ csrf_field() }}
                    ...
                    <div class="box-body table-responsive">
                        @if(count($data)>0)
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ url('admin/designation/edit/'.$row->id) }}" class="editable">
...
@section('js')
    <script>
        $('a[href="#delete"]').on('click',function(){
            var id = $(this).data('id');
            $('#delete').modal('show');
            $('#delete_link').attr('href',"{{ url('admin/designation/delete/') }}/"+id);
        });
    </script>
@endsection